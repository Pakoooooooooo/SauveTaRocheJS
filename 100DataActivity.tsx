...
type DataActivityNavigationProp = NativeStackNavigationProp<RootStackParamList, 'Data100'>;
...
export default function Data100Activity({ navigation }: NavigationProps) {
  ...
  const handlePolygonPress = () => {
    Alert.alert(
      '🌊 Zone inondée',
      'Cette zone sera submergée par la montée des eaux dans 100 ans avec une élévation de +0.85m du niveau de la mer.',
    ...
    <View style={styles.container}>
      ...
      {showInfo && (
        <View style={styles.infoBanner}>
          <View style={styles.infoContent}>
            <Text style={styles.infoTitle}>Projection +100 ans (2125)</Text>
            <Text style={styles.infoText}>Montée : +0.85m</Text>
      ...
      <View style={styles.legend}>
        <View style={styles.legendItem}>
          <View style={[styles.legendColor, { backgroundColor: 'rgba(255, 149, 0, 0.5)' }]} />
      ...
      >
        ...
        {floodZones.map((zone) => (
          <Polygon
            ...
            strokeColor="rgba(255, 100, 0, 0.9)"
            strokeWidth={2}
            tappable={true}
